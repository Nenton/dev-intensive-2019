...
object Utils {
    @RegExp
    private const val regexpUrl = "((https://|www.|https://www.)?github.com/(?!enterprise|features|topics|collections" +
            "|trending|events|marketplace|pricing|nonprofit|customer-stories|security|login|join)[\\w\\d-_]{1,39}/?)|"
